...
class StudentEnrolmentForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['Name', 'Surname', 'Gender', 'DOB', 'Email', 'Grade_Level', 'Address', 'Phone_Number', 'Parent_Name', 'Parent_Surname', 'Parent_Email', 'Relationship', 'Parent_Phone_Number']
        labels = {
            'Name': 'Name',
            'Surname': 'Surname',
            'Gender': 'Gender',
...
class JobApplicationsForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['Name', 'Surname', 'Gender', 'pPosition', 'DOB', 'Marital_Status', 'Email', 'Address', 'PhoneNumber']
        labels = {
            'Name': 'Name',
            'Surname': 'Surname',
            'Gender': 'Gender',
