...
export const AuthProvider = ({ children }) => {
  ...
  const registerAdminUser = async (email, username, first_name, last_name, password, password2) => {
    try {
      const response = await axios.post("http://127.0.0.1:8000/register/staff/", {
        email,
        username,
        first_name,
        last_name,
